...
import { SafeAreaView, StyleSheet, Text, TouchableOpacity, Image, View, Platform, Dimensions, Pressable, Modal, Alert } from 'react-native';
...
function Home({ navigation }) {
    ...
    function createCourse() {
        ...
        addDoc(collection(db,"Xcourses"), {
            ...
            description: "Computer operations involve the basic functions and processes that a computer performs to executes tasks and manipulate data. These operations include input, processing, storage, and output.",
            instructor: userUID,
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.headerContainer}>
                <Image
                    ...
                    defaultSource={require("../../assets/Xskool-v-gold.png")}
                    style={styles.logo}
                />
                <View>
